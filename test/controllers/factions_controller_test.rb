...
class FactionsControllerTest < ActionController::TestCase
  ...
  test "should create faction" do
    assert_difference('Faction.count') do
      post :create, faction: { color: @faction.color, name: @faction.name, points: @faction.points, type: @faction.type }
    end
  ...
  test "should update faction" do
    patch :update, id: @faction, faction: { color: @faction.color, name: @faction.name, points: @faction.points, type: @faction.type }
    assert_redirected_to faction_path(assigns(:faction))
  end
